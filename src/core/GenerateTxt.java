...
import core.neo4j.findVandalism.FindVandalism;
import core.neo4j.findVandalism.QuerySpecialNode;
...
//	}
	...
	public static void generateUserContribsTxt(String user, String totalNodeNumber, int depth, String uclimit, String rvlimit, String src) throws Exception {
		 ...
		 List<String> userTxt = ReadUserContribXML.startWithUser(user, uclimit, depth, rvlimit);
